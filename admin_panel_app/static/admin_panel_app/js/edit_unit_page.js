function delete_unit_popup(unit_id) {
    let popup_div = document.getElementById('popup_div');
    popup_div.innerHTML = `
        <div class="analyze_color_8 font_Ray">هشدار!</div>
        <div class="text_color_2 font_Ray">آیا برای حذف واحد مطمئن هستید؟</div>
        <div class="button_group_div margin_top_20 w_100 ju_con_sp_bet">
            ...
            <a class="button_element background_color_2 text_color_0 font_Ray w_48" href="/delete_unit/?unit_id=${unit_id}">حذف</a>
        </div>
    `
