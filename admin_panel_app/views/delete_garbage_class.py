...
class DeleteGarbageClass(LoginRequiredMixin, RoleRequiredMixin, View):
    ...
    def get(self, request):
        ...
        GarbageData.objects.get(id=garbage_id).delete()
        messages.success(request, 'حذف زباله با موفقیت انجام شد')
