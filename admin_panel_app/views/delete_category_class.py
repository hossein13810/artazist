...
class DeleteCategoryClass(LoginRequiredMixin, RoleRequiredMixin, View):
    ...
    def get(self, request):
        ...
        GarbageCategoriesData.objects.get(id=category_id).delete()
        messages.success(request, 'حذف دسته بندی با موفقیت انجام شد')
